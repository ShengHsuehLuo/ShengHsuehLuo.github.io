!function (i) {
    ...
    function t() {
        ...
        this.$closeBtn = i("#about-btn-close"), this.$blog = i("#blog"),
        this.$about = i("#about"), this.$aboutCard = i("#about-card")
    }
    t.prototype = {
        run: function () {
            var s = this;
    ...
    (jQuery), function (s) {
        ...
        function t(t) {
            this.$form = s(t).find("#filter-form"), this.$searchInput = s(t).find("input[name=date]"), this.$archiveResult = s(t).find(".archive-result"), this.$postsYear = s(t).find(".archive-year"), this.$postsMonth = s(t).find(".archive-month"), this.$postsDay = s(t).find(".archive-day"), this.postsYear = t + " .archive-year", this.postsMonth = t + " .archive-month", this.postsDay = t + " .archive-day", this.messages = {
                zero: this.$archiveResult.data("message-zero"), one: this.$archiveResult.data("message-one"), other: this.$archiveResult.data("message-other")
            }
        ...
        , s(document).ready(
            function () {s("#archives").length && new t("#archives").run()}
        )
    }
        (jQuery), function (o) {
            "use strict";
        ...
        , showPosts: function(t) {
                var s = this, e = s.categories + "[data-" + s.dataCategory + "*='" + t + "']", i = s.posts + "[data-" + s.dataCategory + "*='" + t + "']";
    ...
    t.prototype = {
        ...
        , resize: function () {
            this.$codeBlocks.each(function () {
                var t = i(this).find(".gutter"), s = i(this).find(".code"), e = s.width() - s.innerWidth(), e = i(this).outerWidth() - t.outerWidth() + e;
        ...
        s(document).ready(function () {
            function t() {
                ...
                480 < s(window).height() && (t = !0), s(".fancybox").fancybox({
                    buttons: ["fullScreen", "thumbs", "share", "download", "zoom", "close"], thumbs: {
                        autoStart: t, axis: "x"
                    }
...
(jQuery), function (t) {
    ...
    (jQuery), function (t) {
        ...
        function s() {
            ...
            this.$openBtn = t("#btn-open-sidebar"), 
            this.$closeBtn = t("#header, #main, .post-header-cover, #sidebar_close "), 
            this.$header = t("#header"), this.$headerElements = {
