(function($) {
  ...
  Header.prototype = {
    ...
    animate: function() {
      ...
      var tmp = this.lastScrollTop;
      // Checks if the user has scrolled enough down and has past the navbar
      if ((scrollTop > this.lastScrollTop) && (scrollTop > this.headerHeight)) {
        //console.log(scrollTop +","+ tmp +","+ this.headerHeight);
        this.$header.addClass(this.headerUpCSSClass);
      }
      else if (scrollTop + $(window).height() < $(document).height()) {
        //console.log(scrollTop +","+ tmp +","+ this.headerHeight+","+$(window).height()+","+$(document).height());
